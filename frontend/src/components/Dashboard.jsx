  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-500 dark:bg-blue-900 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
          <h3 className="text-lg font-semibold mb-2">Total Members</h3>
          <p className="text-4xl font-bold">{stats.totalMembers}</p>
        </div>
        
        <div className="bg-green-500 dark:bg-green-900 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
          <h3 className="text-lg font-semibold mb-2">Active Tasks</h3>
          <p className="text-4xl font-bold">{stats.activeTasks}</p>
        </div>
        
        <div className="bg-purple-500 dark:bg-purple-900 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
          <h3 className="text-lg font-semibold mb-2">Knowledge Articles</h3>
          <p className="text-4xl font-bold">{stats.totalArticles}</p>
        </div>
        
        <div className="bg-red-500 dark:bg-red-900 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-8 transition-colors duration-200">
        <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Recent Tasks</h2>
              ...
              <div key={task.task_id} className="border-l-4 border-blue-500 pl-4 py-2">
                ...
                <div className="flex items-center gap-4 mt-2">
                  <span className={`px-3 py-1 rounded text-sm ${
                    ...
                    task.status === 'in_progress' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' :
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        <div className="bg-gradient-to-br from-blue-400 to-blue-600 dark:from-blue-700 dark:to-blue-900 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition cursor-pointer">
          <h3 className="text-xl font-bold mb-2">📚 Knowledge Base</h3>
          <p className="text-sm">Access tutorials and documentation</p>
        </div>
        
        <div className="bg-gradient-to-br from-green-400 to-green-600 dark:from-green-700 dark:to-green-900 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition cursor-pointer">
          <h3 className="text-xl font-bold mb-2">🤖 Robot Archive</h3>
          <p className="text-sm">View past robot designs and specs</p>
        </div>
        
        <div className="bg-gradient-to-br from-purple-400 to-purple-600 dark:from-purple-700 dark:to-purple-900 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition cursor-pointer">
